...
if (mysqli_num_rows($ato) > 0) {
    $row = mysqli_fetch_array($ato)
    ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        if (mysqli_num_rows($designacao_ato_filho) > 0) {
                                            $contador = 1;
                                            while ($row2 = mysqli_fetch_array($designacao_ato_filho)) {
                                                ...
                                                while ($row3 = mysqli_fetch_array($atos_filho)) {
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="skill-shortcode">
                                    ...
                                    if (mysqli_num_rows($maior_cobertura) > 0) {
                                        while ($row2 = mysqli_fetch_array($maior_cobertura)) {
                                            $nome_curso = get_curso($row2['ID_CURSO']);
                                            $row3 = mysqli_fetch_array($nome_curso);
